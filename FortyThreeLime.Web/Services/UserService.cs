...
namespace FortyThreeLime.Web.Services
{
    ...
    /// Provides User Data
    /// </summary>
    /// <seealso cref="FortyThreeLime.Web.Services.IAPIControllerService{FortyThreeLime.Admin.API.Controllers.AccountController, FortyThreeLime.Admin.API.Controllers.UsersController}" />
    internal sealed class UserService : IAPIControllerService<AccountController, UsersController>
    {
